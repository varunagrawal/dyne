"""
Script to estimate trajectory from Pybullet data using the Bloesch State Estimator.

python scripts/varun05_bloesch_estimator_pybullet.py data/pybullet/config.yaml --robot models/a1.urdf -T 5 -o results/bloesch_estimator
"""
...
def run(estimator: Bloesch, pybullet: datasets.PybulletDataset, T: float):
...
def main():
    ...
    estimator = Bloesch(base_imu=base_imu,
